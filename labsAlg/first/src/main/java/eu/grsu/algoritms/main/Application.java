...
//        BigRectangle bigLowRectangle=new BigRectangle(10,9);
...
//        lowRectangleList.add(new LowRectangle(3,2));
//        lowRectangleList.add(new LowRectangle(7,1));
//        lowRectangleList.add(new LowRectangle(3,3));
//        lowRectangleList.add(new LowRectangle(2,4));
//        lowRectangleList.add(new LowRectangle(9,2));
//        lowRectangleList.add(new LowRectangle(4,3));
//        lowRectangleList.add(new LowRectangle(3,5));
//        lowRectangleList.add(new LowRectangle(5,2));
//        lowRectangleList.add(new LowRectangle(3,1));
